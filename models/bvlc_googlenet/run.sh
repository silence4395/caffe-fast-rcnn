...
cd ../../../
./build/tools/caffe test --gpu=$GPU_ID --model=models/bvlc_googlenet/train_val.prototxt --weights=models/bvlc_googlenet/bvlc_googlenet.caffemodel |& tee log
mv log models/bvlc_googlenet/. 